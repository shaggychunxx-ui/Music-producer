...
from signals_kb import lessons, modes, recipes, source, techniques

_EXTRACT = Path(__file__).resolve().parent.parent / "knowledge" / "lesson_extract.txt"
