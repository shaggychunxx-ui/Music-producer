# Music-producer monorepo

This repository is a **library of separate agents**. Read root `AGENTS.md` for routing.

- Open only the agent folder that matches the user’s question.
