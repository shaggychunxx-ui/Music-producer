...
from movement_kb import INSTRUMENT, get_recipe, get_topic, list_topics, search_kb
from movement_kb.recipes import RECIPES
...
def main(argv=None):
    p = argparse.ArgumentParser(prog="movement_kb")
