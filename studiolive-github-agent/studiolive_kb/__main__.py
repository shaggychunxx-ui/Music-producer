...
from studiolive_kb import INSTRUMENT, get_topic, list_topics, get_recipe, search_kb
from studiolive_kb.recipes import RECIPES

def _p(o):
    print(json.dumps(o, indent=2, ensure_ascii=False) if isinstance(o, (dict, list)) else o)

def main(argv=None):
    p = argparse.ArgumentParser(prog="studiolive-kb")
